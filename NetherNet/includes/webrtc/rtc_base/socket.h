...
class RTC_EXPORT Socket {
 public:
  ...
  enum Option {
    ...
    OPT_SO_BROADCAST,          // Additional enum value added in mcbe
    OPT_IPV6_JOIN_GROUP,       // Additional enum value added in mcbe
    OPT_IPV6_MULTICAST_LOOP,   // Additional enum value added in mcbe
